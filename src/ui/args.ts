...
export const USAGE = [
  ...
  '',
  'In play, answer with an option number, or with one of the keywords: roll,',
  'passage, suggest, accuse, ask, notes, end, quit. Where you move to is always',
  'picked by number from the destinations the die allows.',
  '',
